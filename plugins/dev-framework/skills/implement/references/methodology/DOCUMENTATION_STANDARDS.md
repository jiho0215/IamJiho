...
Capture every architectural or design decision. Use the ADR template from `${CLAUDE_PLUGIN_ROOT}/skills/implement/references/templates/ADR_TEMPLATE.md`.
...
Document what each feature does, why it exists, and how it works. Use the template from `${CLAUDE_PLUGIN_ROOT}/skills/implement/references/templates/FEATURE_SPEC_TEMPLATE.md`.
...
Document the testing strategy for each feature. Use the template from `${CLAUDE_PLUGIN_ROOT}/skills/implement/references/templates/TEST_PLAN_TEMPLATE.md`.
